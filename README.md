...
- **EDA:** Discovered near-zero linear correlation ($r \approx 0.00$) between device price and star rating.
- **Clustering ($k=4$):**
...
```bash
# 1. Clone repository
git clone [https://github.com/your-username/mobile-product-segmentation.git](https://github.com/your-username/mobile-product-segmentation.git)
